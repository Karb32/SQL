...
7. Вывести id, имя, email, дату создания пользователей.

   select id, name, email, created_on from students;
   
8. Вывести пользователей где пароль 12333.
...
10. Вывести пользователей где в имени есть слова Анна.
...
12. Вывести пользователей где в имени в конце есть a.
...
14. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и имею пароль 1m313.
...
16. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть 8.
...
21. Вывести пользователей у которых id меньше 137 или больше 188.
...
26. Вывести пользователей где пароль равен 12313, 1m333, 123313.
...
31. Вывести id пользователя, имя, дату создания пользователя. Отсортировать по порядку возростанию даты добавления пользователя.
